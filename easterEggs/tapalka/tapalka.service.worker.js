...
/** @type {string} */
const OFFLINE_URL = 'tapalka.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["tapalka.html","tapalka.js","tapalka.offline.html","tapalka.icon.png","tapalka.apple-touch-icon.png","tapalka.audio.worklet.js","tapalka.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tapalka.wasm","tapalka.pck"];
